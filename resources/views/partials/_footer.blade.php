...
<footer>
    ...
    <div class="container">
      <div class="wthree-foo-grids">
        <div class="col-md-3 wthree-footer-grid">
          ...
          <p>Kings Business Consult is an online advertising agency. We bridge the gap between seller & buyers.</p>
          <p>We bring sellers and buyers on the same platform.</p>
        </div>
        <div class="col-md-3 wthree-footer-grid">
        ...
        <div class="col-md-3 wthree-footer-grid">
          ...
          <address>
            ...
            <ul class="location">
              ...
              <li><a href="tel:0266605779">0266605779</a></li>
            </ul>
            <div class="clearfix"> </div>
            <ul class="location">
              <li><span class="glyphicon glyphicon-envelope"></span></li>
              <li><a href="mailto:kingsbus108@gmail.com">KINGS BUSINESS CONSULT</a></li>
            </ul>
          </address>
        </div>
        <div class="clearfix"></div>
  ...
  <div class="container">
    <div class="w3-footer-logo">
      <h1><a href="{{ url('admin') }}"><span>kbc-</span>Agency</a></h1>
    </div>
